...
#' detect.bayes.unknown.pre(GEN=GEN,alpha=0.1,nulower=5,nuupper=30,lenth1=2, lenth0=2, thlower1=c(-Inf,0),thlower0=c(-Inf,0),
#'                 score="hyvarinen",GLP0=GLP0,LLP0=LLP0,GLP1=GLP1,LLP1=LLP1)
#'
#' #using log score, normalizing constant unknown
#' detect.bayes.unknown.pre(GEN=GEN,alpha=0.1,nulower=10,nuupper=25,lenth1=2, lenth0=2, thlower1=c(-Inf,0),thlower0=c(-Inf,0),
...
detect.bayes.unknown.pre=function(GEN,alpha,nulower=NULL,nuupper=NULL,score="hyvarinen",c=0.5,n=1000,
                         lenth1, lenth0, thlower1=NULL,thupper1=NULL,
                         thlower0=NULL,thupper0=NULL,
